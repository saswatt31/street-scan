  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background text-foreground uppercase-header">
      ...
      <aside className={cn(
        ...
        {/* Logo */}
        <div className="flex items-center gap-4 px-6 py-10 border-b border-border mb-4">
          <div className="w-20 h-20 rounded-[28px] flex items-center justify-center bg-white/5 shadow-2xl shadow-primary/20 p-2">
        ...
        <div className="px-5 py-6 border-t border-border mt-auto">
           <Link href="/" className={cn(buttonVariants({ variant: 'ghost' }), "w-full justify-start gap-3 h-11 px-4 text-muted-foreground hover:text-foreground hover:bg-muted/50 font-bold rounded-xl")}>
